...
import { Box, Typography, Grid, Avatar, List, ListItem, ListItemIcon, ListItemText, IconButton,Divider } from "@mui/material";
      ...
      <Box mt={4}>
        ...
        <List>
          <ListItem>
            ...
            <ListItemText
              primary="Bachelor of Technology in Computer Science"
              secondary="2020 - 2024 | XYZ University"
            />
          </ListItem>
          <ListItem>
            <ListItemIcon>
            ...
            <ListItemText
              ...
              secondary="2018 - 2020 | ABC Senior Secondary School"
            />
          </ListItem>
          <ListItem>
            <ListItemIcon>
            ...
            <ListItemText
              ...
              secondary="2016 - 2018 | DEF High School"
            />
          </ListItem>
        </List>
      </Box>
